...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/reference-handler-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/reference-handler-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add reference-handler
# for installing globally
pixi global install reference-handler
```
...
It is possible to list all of the versions of `reference-handler` available on your platform:
...
```
pixi search reference-handler --channel conda-forge
```
